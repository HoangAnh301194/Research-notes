...
\begin{frame}{Nội dung trình bày}
  ...
  \begin{tabularx}{\linewidth}{@{}C{0.72cm}L{3.55cm}Y@{}}
    ...
    \numlabel{4} & \textcolor{PTITRed}{\bfseries Thực nghiệm} & Kết quả ngắn hạn, dài hạn và hiệu năng.\\
  \end{tabularx}}
  \vspace{0.35cm}
  \begin{tcolorbox}[keypanel]
    \centering\bfseries Trọng tâm: cách VideoMamba tổ chức chuỗi token 3D và huấn luyện hiệu quả cho video dài.
  \end{tcolorbox}
  \vfill
  \source{Nguồn: VideoMamba, Abstract và Section 1.}
\end{frame}
...
\begin{frame}{1.1. Video dài cần mô hình hóa vừa cục bộ vừa toàn cục}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title=Hai tính chất đối nghịch]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title=Khoảng trống của các họ mô hình]
        \renewcommand{\arraystretch}{1.35}
        {\fontsize{7.5}{8.6}\selectfont\begin{tabularx}{\linewidth}{@{}L{1.72cm}Y Y@{}}
          \toprule
          ...
          VideoMamba & Scan tuyến tính & Cần thiết kế thứ tự scan phù hợp.\\
          \bottomrule
        \end{tabularx}}
      \end{tcolorbox}
      \vspace{0.18cm}
...
\begin{frame}{2.1. Input video được chuyển thành chuỗi token không-thời gian}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.30\textwidth}
      \begin{tcolorbox}[titlepanel,title=1. Video tensor $\mathbf X_v$, height=4.65cm]
        \centering
        \[
    ...
    \begin{column}{0.33\textwidth}
      \begin{tcolorbox}[titlepanel,title=2. Patchify và $L$, height=4.65cm]
        \raggedright
    ...
    \end{column}
    \begin{column}{0.30\textwidth}
      \begin{tcolorbox}[titlepanel,title=3. Chuỗi đưa vào encoder, height=4.65cm]
        \centering
...
\begin{frame}{2.2. VideoMamba: encoder ViT-like với B-Mamba cho chuỗi token 3D}
  \vspace{0.04cm}
  \centering
  \includegraphics[width=0.97\linewidth,height=3.70cm,keepaspectratio]{figure-3-framework.png}\par
  \vspace{-0.03cm}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.58\textwidth}
      \begin{tcolorbox}[titlepanel,title=Luồng dữ liệu VideoMamba]
...
\begin{frame}{2.3. Spatiotemporal bidirectional scan strategies}
  \vspace{0.08cm}
  \centering
  \includegraphics[width=0.98\linewidth,height=3.80cm,keepaspectratio]{figure-4-scan.png}\par
  \vspace{-0.03cm}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[panel]
...
\begin{frame}{3.1. Masked video pretraining: objective và masking strategy}
  \vspace{0.05cm}
  \centering
  \includegraphics[width=0.97\linewidth,height=3.22cm,keepaspectratio]{figure-5-masking.png}\par
  \vspace{0.04cm}
  \begin{columns}[T,onlytextwidth]
...
\begin{frame}{3.2. Architecture scaling và self-distillation}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.31\textwidth}
      \begin{tcolorbox}[titlepanel,title=Model scale]
    ...
    \begin{column}{0.65\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=2.62cm,keepaspectratio]{figure-6-distillation.png}\par
    \end{column}
  \end{columns}
  \vspace{0.02cm}
  \begin{columns}[T,onlytextwidth]
...
\begin{frame}{4.1. Thiết lập thực nghiệm}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title=Video dài]
...
\begin{frame}{4.2. Kết quả video ngắn: Kinetics-400 và Something-Something V2}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title={Kinetics-400, supervised}]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title={Something-Something V2, supervised}]
        {\fontsize{7.9}{9.0}\selectfont
        \renewcommand{\arraystretch}{1.28}
        \begin{tabularx}{\linewidth}{@{}Y C{1.05cm} C{1.05cm}@{}}
          \toprule
...
\begin{frame}{4.3. Kết quả video dài: Breakfast, COIN và LVU}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.56\textwidth}
      \begin{tcolorbox}[titlepanel,title=Kết quả long-term video understanding]
...
\begin{frame}{5. Conclusion, limitations và research relevance}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title=Kết luận của bài báo]
        \begin{itemize}\tightitems
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[titlepanel,title=Giới hạn được tác giả nêu]
        \begin{itemize}\tightitems
      ...
      \begin{tcolorbox}[greenpanel]
        ...
        Các kết quả hiệu năng và accuracy được báo cáo theo cấu hình training, input và GPU của paper; không suy diễn trực tiếp sang một edge platform cụ thể.
      \end{tcolorbox}
    \end{column}
  \end{columns}
  \vfill
